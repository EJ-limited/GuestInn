  ...
  return (
   <button
    className={`ease group relative z-30 box-border inline-flex ${
        width ? width : "w-auto"
      } ${padding} cursor-pointer items-center justify-center overflow-hidden rounded  bg-transparent  px-8 py-3 font-bold bg-yellow-400 text-white transition-all duration-300 focus:outline-none`}
      onClick={onClick}
    >
